"""
Django settings for demo_42897 project.
...
WSGI_APPLICATION = 'demo_42897.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_42897 API",
    "DESCRIPTION": "API documentation for demo_42897 App",
    "VERSION": "v1",
}
